...
The random walk model we used in the [forecasting concepts](forecasting-concepts) session is a special case of a more general class of models called *autoregressive (AR) models*.
